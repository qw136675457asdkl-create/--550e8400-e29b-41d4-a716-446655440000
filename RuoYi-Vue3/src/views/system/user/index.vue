  ...
  <div class="app-container">
            <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
              <el-form-item label="工号" prop="userName">
                <el-input v-model="queryParams.userName" placeholder="请输入工号" clearable style="width: 240px" @keyup.enter="handleQuery" />
              </el-form-item>
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="工号" align="center" key="userName" prop="userName" v-if="columns.userName.visible" :show-overflow-tooltip="true" />
              <el-table-column label="用户名称" align="center" key="nickName" prop="nickName" v-if="columns.nickName.visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" v-model="open" width="600px" append-to-body>
      <el-form :model="form" :rules="rules" ref="userRef" label-width="80px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="工号" prop="userName">
              <el-input v-model="form.userName" :disabled="form.userId !== undefined" placeholder="请输入工号" maxlength="30" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
...
const columns = ref({
  ...
  userName: { label: '工号', visible: true },
...
function getPromptPasswordError(value) {
  if (!value || value.length < 5 || value.length > 20) {
...
function handleStatusChange(row) {
  ...
  proxy.$modal.confirm('确认要"' + text + '"工号为"' + row.userName + '"的用户吗?').then(function () {
...
function handleResetPwd(row) {
  proxy.$prompt('请输入工号"' + row.userName + '"的新密码', "提示", {
    ...
    inputValidator: (value) => {
      return getPromptPasswordError(value)
    },
  }).then(({ value }) => {
